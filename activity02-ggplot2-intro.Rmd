...
**Response**: Each species is a different color. This makes this boxplot more visually pleasing.
...
**Response**: There is an obvious trend in each group, because the data points are clustered by species. 
